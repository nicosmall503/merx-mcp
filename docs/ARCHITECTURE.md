...
graph TB
    ...
    MCP[merx MCP Server<br>53 tools / 30 prompts / 21 resources]
...
| Full access | API key + private key | 53 tools: + transfers, swaps, approvals, contract execution, intents, x402 |
